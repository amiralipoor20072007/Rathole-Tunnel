...
```
bash <(curl -Ls --ipv4 https://raw.githubusercontent.com/amiralipoor20072007/rathole-tunnel/main/rathole.sh)
```
ورژن دوم (با ورژن قبلی سازگاری ندارد / پیشنهادی / قابلیت مالتی سرویس و مالتی سرور)

```
bash <(curl -Ls --ipv4 https://raw.githubusercontent.com/amiralipoor20072007/rathole-tunnel/main/rathole_v2.sh)
```
